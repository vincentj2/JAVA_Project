...
public class EquilateralTrianglarPyramid extends EquilateralTrianglarPrism{
	...
	EquilateralTrianglarPyramid(double x1,double x2,double x3,double y1,double y2,double y3,double normalHeight,double slantHeight) {
		super(x1, y1, x2, y2, x3, y3, slantHeight);
